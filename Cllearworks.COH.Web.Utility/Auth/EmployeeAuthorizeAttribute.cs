...
namespace Cllearworks.COH.Web.Utility.Auth
{
    ...
    public class EmployeeAuthorizeAttribute : AuthorizationFilterAttribute
    {
        ...
        protected virtual bool IsAuthorized(HttpActionContext actionContext)
        {
            ...
            var userType = Convert.ToInt32(principal.FindFirst(Constants.ApplicationUserTypeClaimType).Value);

            return principal.HasClaim(x => x.Type == Constants.EmployeeIdClaimType) && userType == (int)UserTypes.Employee;
        }
